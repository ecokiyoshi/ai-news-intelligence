...
for Ubuntu VPS provisioning, secure GitHub Actions deployment, runtime configuration, immutable
image rollback, lifecycle commands, logs, and health checks. The existing `compose.yaml` remains
