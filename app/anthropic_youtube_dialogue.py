...
Do not preserve the source chapter count. The source may contain 9, 10, 15, 20, or more chapters;
the Japanese version must not mechanically use the same number. Do not map chapters one-to-one.
Merge, split, reorder, or remove them for clarity, natural flow, no repetition, and runtime. Return
...
viewer questions, reacts, then raises the next question. Sabisu answers briefly like a knowledgeable
friend rather than a lecturer. Keep useful technical terms but explain unfamiliar ones briefly and
casually. Politeness is allowed only where natural, such as an opening or direct viewer address. Do
not sound childish. Preserve facts, caveats, names, dates, numbers, organizations, and uncertainty.
Never invent facts, quotes, statistics, sources, laws, dates, outcomes, claims, or research. Return
only the typed structured schema.
"""
...
def _to_dialogue_script(
    parsed: AnthropicYouTubeDialogueResponse,
